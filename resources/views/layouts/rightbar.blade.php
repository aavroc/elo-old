<div class="xp-rightbar">
                  ...
                  <ul class="xp-horizontal-menu">
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="{{url('/')}}">Dashboard 1</a></li>
                        <li><a href="{{url('/dashboard-2')}}">Dashboard 2</a></li>
                        <li><a href="{{url('/dashboard-3')}}">Dashboard 3</a></li>
                      </ul>
                    </li>
    ...
    <div class="xp-footerbar">
        <footer class="footer">
            <p class="mb-0">© 2019 Booster - All Rights Reserved.</p>
        </footer>
    </div>
    <!-- End XP Footerbar -->
</div>